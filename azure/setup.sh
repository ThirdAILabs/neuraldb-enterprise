...
# This creates 4 VMs as of now. The first one is the head node that has 100GBs of disk space and the PRIVATE IP of the VM inside the subnet has been hardcoded to 10.0.0.4
