...
bash ../nomad/nomad_jobs/submit_nomad_job.sh $PUBLIC_SERVER_IP ../nomad/nomad_jobs/search_ui_job.hcl.j2 PUBLIC_SERVER_IP=$PUBLIC_SERVER_IP PRIVATE_SERVER_IP=$PRIVATE_SERVER_IP
